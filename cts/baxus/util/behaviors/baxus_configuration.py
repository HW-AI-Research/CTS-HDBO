...
from cts.baxus.util.behaviors.embedded_turbo_configuration import EmbeddedTuRBOBehavior, EmbeddedSTuRBOBehavior
...
@dataclass
class SBAxUSBehavior(EmbeddedSTuRBOBehavior):
    """
    The behavior of the BAxUS algorithm.
